...
self.addEventListener('fetch', event => {
    ...
    // We check for .includes() to support being served from subdirectories (e.g. /LMS/scorm-proxy/)
    if (!url.pathname.includes('scorm-proxy/')) return;

    // Correctly extract the proxy path by finding where 'scorm-proxy/' starts and taking everything after it
