...
export default async function renderAdminUsers(container) {
  ...
  container.innerHTML = `
    ...
    <div id="bulk-actions-bar" class="card mb-4 slide-up hidden" style="display: none; background: hsl(var(--color-primary)/0.05); border: 1px dashed hsl(var(--color-primary)); padding: 1rem 1.5rem;">
  ...
  function setupTableInteractions() {
    ...
    container.querySelectorAll('.edit-btn').forEach(btn => {
      btn.addEventListener('click', (e) => {
        ...
        pwField.placeholder = 'השאר ריק אם אין שינוי סיסמה';
        pwField.value = '';
