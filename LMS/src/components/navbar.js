...
export function renderNavbar(user) {
  ...
  if (isSuperAdminRole(user.role)) {
    ...
    linksStr += `<a href="#/superadmin/assignments" class="nav-link"><i class='bx bx-link'></i> הקצאת תוכן</a>`
    ...
    linksStr += `<a href="#/admin/scorm" class="nav-link"><i class='bx bx-upload'></i> ניהול תוכן למידה</a>`
